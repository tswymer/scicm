...
import type { ValMapSchemaApi } from './ValMapSchemaApi.js';
import { ValMaps, ValMapsType } from './ValMaps.js';
import { DefaultValMaps, DefaultValMapsType } from './DefaultValMaps.js';
  ...
  implements ValMapSchemaType<T>
{
   ...
   */
  static _entityName = 'ValMapSchema.js';
  /**
