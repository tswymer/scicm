...
import type { IntegrationAdapterDesigntimeArtifactsApi } from './IntegrationAdapterDesigntimeArtifactsApi.js';
  ...
  implements IntegrationAdapterDesigntimeArtifactsType<T>
{
   ...
   */
  static _entityName = 'IntegrationAdapterDesigntimeArtifacts';
  /**
