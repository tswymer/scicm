...
import type { ValueMappingDesigntimeArtifactsApi } from './ValueMappingDesigntimeArtifactsApi.js';
import { ValMapSchema, ValMapSchemaType } from './ValMapSchema.js';
  ...
  implements ValueMappingDesigntimeArtifactsType<T>
{
   ...
   */
  static _entityName = 'ValueMappingDesigntimeArtifacts';
  /**
