...
import type { ServiceEndpointsApi } from './ServiceEndpointsApi.js';
import { EntryPoints, EntryPointsType } from './EntryPoints.js';
import { ApiDefinitions, ApiDefinitionsType } from './ApiDefinitions.js';
import { CustomTags, CustomTagsType } from './CustomTags.js';
  ...
  implements ServiceEndpointsType<T>
{
   ...
   */
  static _entityName = 'ServiceEndpoints.js';
  /**
