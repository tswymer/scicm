...
import type { ScriptCollectionDesigntimeArtifactsApi } from './ScriptCollectionDesigntimeArtifactsApi.js';
  ...
  implements ScriptCollectionDesigntimeArtifactsType<T>
{
   ...
   */
  static _entityName = 'ScriptCollectionDesigntimeArtifacts';
  /**
