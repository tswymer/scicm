...
import type { IntegrationDesigntimeArtifactsApi } from './IntegrationDesigntimeArtifactsApi.js';
import { Configurations, ConfigurationsType } from './Configurations.js';
import { Resources, ResourcesType } from './Resources.js';
  ...
  implements IntegrationDesigntimeArtifactsType<T>
{
   ...
   */
  static _entityName = 'IntegrationDesigntimeArtifacts';
  /**
